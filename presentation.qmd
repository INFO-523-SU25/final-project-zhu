...
title-slide-attributes:
  data-background-image: images/close-up-of-stock.jpg
...
![](images/shanghai-stock-exchange.jpeg){width="622"}
...
<audio controls> <source src="audio/slide1.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
::: {.column width="50%"}
```{=html}
<div class="callout callout-style-default callout-note p-2 callout-titled">

<div class="callout-header d-flex align-content-center">
<div class="callout-icon-container">
<i class="callout-icon"></i> Q1. Prediction Horizon
</div>
...
<div class="callout-header d-flex align-content-center">
<div class="callout-icon-container">
<i class="callout-icon"></i>Q2. Feature Significance
</div>
</div>
<div class="callout-body-container callout-body">
...
::: {.column width="50%"}
```{=html}
<div class="callout callout-style-default p-2 callout-note callout-titled">
<div class="callout-header d-flex align-content-center">
<div class="callout-icon-container">
<i class="callout-icon"></i>Q3. Threshold Sensitivity
</div>
</div>
<div class="callout-body-container callout-body">
...
![](images/technical-analysis.jfif){width="333"}
:::
:::::
<audio controls> <source src="audio/slide2.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
:::
...
<audio controls> <source src="audio/slide3.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide4.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide5.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide6.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
![](images/trading-dashboard.png){width="450px"}
...
![](images/trading-in-equities-markets_Featured-Image.png){width="450px"}

<audio controls> <source src="audio/slide7.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide8.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide9.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
...
<audio controls> <source src="audio/slide10.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
